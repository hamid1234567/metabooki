...
- ابزار رنگ متن از color picker آزاد به ۶ سواچ ثابت وب تبدیل شد تا هر انتخاب رنگ یک کلیک مستقل داشته باشد و انتخاب رنگ‌های بعدی هم بدون گیر کردن اعمال شود.
...
| Text color | پاس کدی | پاس کدی | پاس کدی | رنگ از ۶ سواچ ثابت اعمال می‌شود و هر کلیک، color جدید را مستقیم روی selection یا بلاک انتخاب‌شده ذخیره می‌کند. |
