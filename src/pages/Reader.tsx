...
export default function Reader() {
  ...
  const renderBlock = (block: any, idx: number) => {
    ...
    const renderInline = () => block.inline?.length ? block.inline.map((span: any, inlineIndex: number) => {
      ...
      const formatted = <span style={{ fontWeight: span.bold ? 800 : undefined, fontStyle: span.italic ? 'italic' : undefined, color: span.color, backgroundColor: span.backgroundColor, fontFamily: span.fontFamily, fontSize: span.fontSize }}>{content}</span>
