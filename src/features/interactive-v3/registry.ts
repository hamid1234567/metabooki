...
export function isInteractiveV3Kind(kind?: string): kind is InteractiveV3Kind {
  return Boolean(kind && INTERACTIVE_V3_KINDS.has(kind))
}
...
export function createInteractiveBlockV3(kind: string, printNumber?: PrintPageValue): BookBlockV2 {
  const safeKind = (isInteractiveV3Kind(kind) ? kind : 'quiz') as InteractiveV3Kind
